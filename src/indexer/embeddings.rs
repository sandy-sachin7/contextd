...
impl Embedder {
    ...
    pub fn embed(&self, text: &str) -> Result<Vec<f32>> {
        ...
        let hidden_size = 384; // Known for all-MiniLM-L6-v2
...
mod tests {
    ...
    fn test_embedder_creation_fails_without_model() {
        let result = Embedder::new("non_existent_path");
    ...
    fn test_embedder_inference() {
        ...
        let embedder = Embedder::new(model_dir).expect("Failed to create embedder");
